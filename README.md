...
## 📊 Key Insights
* Identified high-value customers based on membership (Gold vs. Regular).
* Analyzed revenue trends across different quarters and cities.
* Found the top-performing cuisines and restaurants.
